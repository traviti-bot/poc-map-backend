...
router.post('/plotRoute', async (req, res) => {
    try {
        ...
        const response = await axios.get(`https://api.mapbox.com/directions/v5/mapbox/driving/-96.50526%2C33.09641%3B-76.209458%2C39.613184?alternatives=true&geometries=geojson&language=en&overview=full&steps=true&access_token=${MAPBOX_ACCESS_TOKEN}`);
